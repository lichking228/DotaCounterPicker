...
Одной из проблем публичных API является малая выборка игр для редких матчапов (например, *Chen vs Meepo*). Обычный расчет винрейта (`Wins / Games`) может дать ложные 100% при 2 сыгранных матчах.

В этом проекте применяется формула сглаживания:
$$ Score = \frac{Wins + 5}{Games + 10} $$
